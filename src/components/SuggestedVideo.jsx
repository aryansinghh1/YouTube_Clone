...
export default function SuggestedVideo({ video }) {
  ...
  return (
    ...
    >
      <div className="w-36 h-20 bg-gray-700 flex-shrink-0 overflow-hidden rounded relative">
        <img src={video.thumbnail} alt={video.title} className="w-full h-full object-cover" />
        {video.duration && (
          <div className="absolute bottom-1 right-1 bg-black bg-opacity-75 px-1 py-0.5 rounded text-xs font-semibold">
